...
logging.info(f"temp: {args.temp},thre: {args.thre},prior_prob: {args.prior_prob}")
...
# ['Antonym', 'AtLocation', 'CapableOf', 'Causes', 
# 'CausesDesire', 'DerivedFrom', 'Desires', 'HasA', 
# 'HasFirstSubevent', 'HasProperty', 'HasSubevent', 
# 'IsA', 'MadeOf', 'MotivatedByGoal', 'NotDesires', 
# 'PartOf', 'RelatedTo', 'SymbolOf', 'Synonym', 'UsedFo']
...
for epoch in range(n_epochs):
    ...
    for idx in range(len(input_lengths)):
        loss = train_tree(
            ...
            encoder_optimizer, predict_optimizer, generate_optimizer, merge_optimizer, output_lang, num_pos_batches[idx], temp=temp, log_prior=log_prior, log_gt_prior=log_gt_prior, 
