...
def train_tree(input_batch, input_length, target_batch, target_length, nums_stack_batch, num_size_batch, generate_nums,
               ...
               merge_optimizer, output_lang, num_pos, temp=0.5, english=False, log_prior=None, log_gt_prior=None, 
    ...
    encoder_outputs, problem_output, word_word, ww_prob, word_op, wo_prob = encoder(input_var, input_length, word_exist_mat, predict.ops, temp=temp, hard=False)
...
def evaluate_tree(input_batch, input_length, generate_nums, encoder, predict, generate, merge, output_lang, num_pos,
                  beam_size=5, temp=0.5, thre=0.5, english=False, max_length=MAX_OUTPUT_LENGTH):
    ...
    word_exist_mat = word_exist(seq_mask)
    encoder_outputs, problem_output, word_word, _, word_op, _ = encoder(input_var, [input_length], word_exist_mat, predict.ops, temp=temp, thre=thre, hard=True)
