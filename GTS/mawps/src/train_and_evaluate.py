...
def train_tree(input_batch, input_length, target_batch, target_length, nums_stack_batch, num_size_batch, generate_nums,
               ...
               eval_know_inputs=None, know_gt_ww=None, common_dict=None, prior_lam=0.1, prior_op_lam=0.1, gt_prior_lam=0.01):
    ...
    loss = masked_cross_entropy(all_node_outputs, target, target_length) + prior_lam*loss_kl+ prior_op_lam*loss_wo_kl + gt_prior_lam*loss_gt_kl
    # loss = loss_0 + loss_1
    loss.backward()
    # clip the grad
