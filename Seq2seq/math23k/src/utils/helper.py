...
class Voc2:
	def __init__(self, config):
		self.frequented = False
		if config.more_nums:
			self.w2id = {'+': 0, '-': 1, '*': 2, '/': 3, '<s>': 4, '</s>': 5, 'number0': 6, 'number1': 7, 'number2': 8, 'number3': 9, 'number4': 10, 'number5': 11, 'number6': 12, 'number7': 13, 'number8': 14, 'number9': 15, 'number10': 16, 'number11': 17}
			self.id2w = {4: '<s>', 5: '</s>', 0: '+', 1: '-', 2: '*', 3: '/', 6: 'number0', 7: 'number1', 8: 'number2', 9: 'number3', 10: 'number4', 11: 'number5', 12: 'number6', 13: 'number7', 14: 'number8', 15: 'number9', 16: 'number10', 17: 'number11'}
			...
			self.w2id = {'+': 0, '-': 1, '*': 2, '/': 3, '<s>': 4, '</s>': 5, 'number0': 6, 'number1': 7, 'number2': 8, 'number3': 9, 'number4': 10, '0.25': 11, '8.0': 12, '0.05': 13, '60.0': 14, '7.0': 15, '5.0': 16, '2.0': 17, '4.0': 18, '1.0': 19, '12.0': 20, '100.0': 21, '25.0': 22, '0.1': 23, '3.0': 24, '0.01': 25, '0.5': 26, '10.0': 27}
			self.id2w = {4: '<s>', 5: '</s>', 0: '+', 1: '-', 2: '*', 3: '/', 6: 'number0', 7: 'number1', 8: 'number2', 9: 'number3', 10: 'number4', 11: '0.25', 12: '8.0', 13: '0.05', 14: '60.0', 15: '7.0', 16: '5.0', 17: '2.0', 18: '4.0', 19: '1.0', 20: '12.0', 21: '100.0', 22: '25.0', 23: '0.1', 24: '3.0', 25: '0.01', 26: '0.5', 27: '10.0'}
			...
			self.w2id = {'+': 0, '-': 1, '*': 2, '/': 3, '<s>': 4, '</s>': 5, 'number0': 6, 'number1': 7, 'number2': 8, 'number3': 9, 'number4': 10}
			self.id2w = {4: '<s>', 5: '</s>', 0: '+', 1: '-', 2: '*', 3: '/', 6: 'number0', 7: 'number1', 8: 'number2', 9: 'number3', 10: 'number4'}
